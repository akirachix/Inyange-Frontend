  ...
  return (
    <nav className="flex flex-row justify-between items-center w-full p-4 bg-white shadow-md fixed top-0 left-0 right-0 z-50">
      ...
      <div className="relative">
        ...
        {itemCount > 0 && (
          <span className="absolute -top-[-10px] -left-[-20px] bg-yellow-500 text-white rounded-full w-6 h-6 sm:w-7 sm:h-7 lg:w-9 lg:h-9 flex items-center justify-center text-[12px] sm:text-[14px] lg:text-[18px]">
            {itemCount}
          </span>
        )}
      </div>
