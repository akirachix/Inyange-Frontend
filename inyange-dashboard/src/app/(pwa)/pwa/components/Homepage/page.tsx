...
{/*        
          <Image
            ...
            width={160}
            height={32}
            className="w-40 sm:w-48 lg:w-[100%] xl:ml-[-25px]"
          /> */}
        </div>
      ...
      <div className="flex items-center justify-between w-full mb-4 ">
        <div className="flex items-center space-x-2 mx-auto md:mx-0">
          <Image src="/images/bmLogo.png" alt="Logo" width={160} height={60} className="w-40 sm:w-48 lg:w-[100%] xl:w-[103%] xl:ml-[-5px]" />
        </div>
      ...
      <h1 className="text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-6xl font-bold mb-4 md:mb-6 leading-relaxed">
      Everything You Need For <br /> Your Building,<br /> All in One Place
        </h1>
      ...
      <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold mb-4 text-black xl:text-[30px]">Top Categories</h2>
    ...
    {filteredMaterials.map((material, index) => (
      ...
      >
        <h3 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 xl:text-[22px]">{material.name}</h3>
        <Image
          src={material.image}
          alt={material.name}
          width={180}
  ...
  <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold mb-4 text-black xl:text-[30px]">Hot Deals</h2>
    ...
    {loading ? (
      ...
      limitedHotDeals.map((deal) => (
        <div key={deal.id} className="flex flex-col justify-center items-center bg-white border border-gray-200 rounded-lg shadow-lg p-4">
          ...
          />
          <h3 className="text-sm sm:text-base font-bold mb-2 xl:text-[17px]">{deal.material_name}</h3>
          <p className="text-xs sm:text-sm text-gray-600 mb-2 xl:text-[16px]">Sale price</p>
          <p className="text-base sm:text-lg font-semibold mb-3 xl:text-[16px]">KES {deal.price}</p>
          <Link href="/pwa/components/Steel">
          <button
