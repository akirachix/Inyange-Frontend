...
//                     return "/images/paint.jpg"; // Make sure this image exists in your public folder
//                   } else if (name.includes("cement")) {
//                     return "/images/duracem.jpg"; // Make sure this image exists in your public folder
//                   }else if (name.includes("carpentry")) {
//                     return "/images/carpentry.jpg"; // Make sure this image exists in your public folder
//                   }else if (name.includes("tiles")) {
//                     return "/images/tiles.jpg"; // Make sure this image exists in your public folder
//                   }else if (name.includes("wood")) {
//                     return "/images/wood.jpg"; // Make sure this image exists in your public folder
//                   }else if (name.includes("steel")) {
//                     return "/images/steel.png"; // Make sure this image exists in your public folder
//                   }else if (name.includes("sheet")) {
//                     return "/images/sheets.jpg"; // Make sure this image exists in your public folder
//                   }else if (name.includes("Brick")) {
//                     return "/images/brick.jpeg"; // Make sure this image exists in your public folder
//                   }else if (name.includes("bricks")) {
//                     return "/images/brick.jpeg"; // Make sure this image exists in your public folder
//                   }
...
const OtherOrders = () => {
  ...
  const getImageSource = (materialName: string) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-6 lg:gap-x-24 mt-8 sm:mt-10 lg:mt-16 w-full justify-center lg:ml-[-5%] xl:ml-[-400px] xl:gap-x-[150px] xl:mt-[25px]">
        {currentMaterials && currentMaterials.length > 0 ? (
          currentMaterials.map((material: MaterialData) => (
            ...
            >
              <Image
                src={getImageSource(material.material_name)}
                alt={material.material_name}
                width={150}
                height={120}
                className="mb-4 lg:mb-0 lg:mr-6 xl:mb-4"
