...
const OtherOrders = () => {
 ...
 return (
   <div className="min-h-screen bg-white p-4 lg:pl-[10%] xl:pl-[20%] flex flex-col items-center">
     ...
     <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-6 lg:gap-x-24 mt-8 sm:mt-10 lg:mt-16 w-full justify-center lg:ml-[-5%] xl:ml-[-400px] xl:gap-x-[150px] xl:mt-[20px]">
     ...
     <div className="flex flex-col sm:flex-row items-center gap-4 mt-6 justify-center sm:mt-8 mb-6 w-full px-4 sm:px-0 lg:mt-20 xl:mt-[30px] lg:ml-[-10%] xl:ml-[-400px]">
       ...
       <div className="w-full sm:w-auto mt-4 sm:mt-0 flex justify-center sm:justify-start">
         <Link
           href="/pwa/components/Pages"
           className="text-[#263C5A] px-8 xl:py-[10px] sm:px-10 lg:px-14 py-2 sm:py-3 lg:py-5 rounded-lg text-xl sm:text-2xl lg:text-3xl lg:ml-[20px] xl:text-[23px] font-semibold bg-[#F8B612] transition-colors xl:ml-[30px]"
         >
           Checkout
         </Link>
       </div>
