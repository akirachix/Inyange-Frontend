...
const OtherOrders = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-4 lg:pl-[10%] xl:pl-[20%] flex flex-col items-center">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-6 justify-center sm:mt-8 mb-6 w-full px-4 sm:px-0 lg:mt-20 lg:ml-[-10%] xl:ml-[-400px] xl:mt-[35px] md:ml-[-40px] md:mt-[8px]">
