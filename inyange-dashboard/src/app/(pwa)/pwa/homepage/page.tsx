    ...
    <div className="flex flex-col bg-white py-4 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 w-full">
      ...
      {/* <div className="flex items-center justify-between w-full mb-4">
        ...
        <div className="relative flex items-center space-x-10 sm:space-x-8 md:space-x-10 mx-auto md:mx-0 xl:mt-[20px] xl:justify-evenly pr-8">
          <Link
            href="/pwa/pages"
            className="relative mt-6 ml-auto sm:ml-6 lg:ml-[10%] xl:ml-[10%] md:ml-[20%]"
          >
...
<div className="flex items-center justify-between w-full mb-4 px-4 sm:px-6 lg:px-8">
  ...
  mt-4 sm:mt-6 md:mt-8 lg:mt-6 xl:mt-4"
    ...
    max-w-[400px] md:max-w-none"
      ...
      {/* Hot Deals section */}
      <div
        className={`w-full py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12 text-center md:text-left text-lg ${
          searchQuery ? "mt-8" : ""
        }`}
      >
        <h2 className="text-2xl sm:text-lg md:text-3xl lg:text-3xl font-bold mb-4 text-black xl:text-[26px]">
          ...
          {loading ? (
            ...
            filteredDeals.map((deal) => (
              ...
              >
                ...
                />
                <h3 className="text-xl sm:text-base font-bold mb-2 xl:text-[17px] md:text-[20px]">
                  {deal.material_name}
                </h3>
                <p className="text-lg sm:text-sm text-gray-600 mb-2 xl:text-[16px] md:text-[15px]">
                  Sale price
                </p>
                <p className="text-lg sm:text-lg font-semibold mb-3 xl:text-[16px] md:text-[15px]">
                  KES {deal.price}
                </p>
                <button
                  onClick={() =>
