...
//   const onSubmit: SubmitHandler<MaterialData> = async () => {
//     setLoading(true);
//     setFeedbackMessage(null);

//     try {
//       const response = await addMaterial(requestData);
...
interface AddMaterialModalProps {
  onClose: () => void;
  onMaterialAdded: (newMaterial: MaterialData) => void; // Add this line
}
